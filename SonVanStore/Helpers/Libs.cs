...
namespace iGoo.Helpers
{
    public class Libs
    {
        ...
        public static string GetNgayDauNam()
        {
            var today = DateTime.Today;
            return today.ToString("01/01/yyyy");
        }
        ...
        public static string GetNgayDauThang()
        {
            var today = DateTime.Today;
        ...
        public static string GetNgayDauThangTruoc() 
        {
            var today = DateTime.Today;
        ...
        public static string GetDayOfWeek(DayOfWeek typeDate)
        {
            string result = "";
            DateTime dt = DateTime.Today;
            int span = dt.DayOfWeek - typeDate;

            if (typeDate == DayOfWeek.Monday)
            {
                if (span == 0)
                    result = dt.ToString("dd/MM/yyyy");
                else if (span < 0)
                    result = dt.AddDays(-6).ToString("dd/MM/yyyy");
                else
                {
                    dt = dt.AddDays(-span);
                    result = dt.ToString("dd/MM/yyyy");
            ...
            if (typeDate == DayOfWeek.Sunday)
            {
                if (span == 0)
                    result = dt.ToString("dd/MM/yyyy");
                else if (span > 0)
                    result = dt.AddDays(+(7 - span)).ToString("dd/MM/yyyy");
            }
